...
public class AuditLogRepositoryTest {
        ...
        static void setUpAll() throws Exception {
                ...
                Instant validTo = validFrom.plus(30, ChronoUnit.DAYS); // <-- Add this line!
                parentCert = new Certificate(
                                ...
                                2048,
                                List.of(),
                                "-----BEGIN CERTIFICATE-----\nTEST\n-----END CERTIFICATE-----", // Your existing string
                                null, // <-- Added: templateName
                                null, // <-- Added: systemOwner
                                "Test" // <-- Added: deploymentMethod
                );
        ...
        void testAuditLogsAreOrderedNewestFirst() throws InterruptedException {
                ...
                assertEquals("NON_COMPLIANT", history.get(1).getStatusResult(),
                                "The older log should be pushed to index 1");
        }
}